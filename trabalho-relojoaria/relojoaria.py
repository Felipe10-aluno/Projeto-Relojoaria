...
def cadastro():
    ...
    label.image = logo 
    label.grid(row=0, column=0, pady=(300,0))
    ...
    def fazer_cadastro():
        ...
        if not matricula or not cpf or not email or not senha:
            ...
            messagebox.showerror("AVISO","Email precisa ter '@gmail.' ")
        elif len(cpf) != 11:
...
#e so demonstrativo mano, n tem problema
    ...
    label_nome3 = Label(frame3, text="Relógio Madeira C", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
    ...
    label_nome4 = Label(frame4, text="Relógio Madeira D", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
    ...
    label_nome5 = Label(frame5, text="Relógio Madeira E", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
    ...
    label_nome6 = Label(frame6, text="Relógio Madeira F", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
    ...
    label_nome7 = Label(frame7, text="Relógio Madeira G", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
    ...
    label_nome8 = Label(frame8, text="Relógio Madeira H", font="Montserrat 12",relief="solid",highlightthickness=3, highlightbackground="white")
...
def clientes(): 
    ...
    button_voltar2.grid(row=0,column=0, pady=(900,0), padx=(0, 0)) 
